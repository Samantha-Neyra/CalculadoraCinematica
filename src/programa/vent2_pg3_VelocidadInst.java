 ...
 * @author USER
 */
public class vent2_pg3_VelocidadInst extends javax.swing.JPanel {

    /**
     * Creates new form vent2_pg3_VelocidadInst
     */
    public vent2_pg3_VelocidadInst() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("   Función de la Velocidad");
        jPanel_Content_pg2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 190, 320, 50));
        ...
        jPanel_Content_pg2.add(cjText2_FuncionDerivada, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 240, 430, 70));
        ...
        jLabel8.setText("Función Inicial de la  Posición");
        jPanel_Content_pg2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 40, 320, 50));
        ...
        jPanel_Content_pg2.add(cjText2_FuncionInicial, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 440, 70));
...
//a + "t" + "^" + ((int)+ n)  + ("±") + b + "t" + "^" + ((int)+( n - 1)) + ("±") + c + "t"
      if (a >= 0 && b >= 0 && c >= 0) { // +n+n+n ---------
          cjText2_FuncionInicial.setText(String.valueOf(a + "t" + "^" + ((int)+ exp)  + "   "+"+"+"    " + b + "t" + "^" + ((int)+( exp - 1)) +"   " +"+"+"   " + c + "t"));
            ...
            cjText2_RESULTADO.setText(String.valueOf((int)(((exp*a)*Math.pow(tiempo, exp-1))+((((exp-1)*b)*Math.pow(tiempo, exp-2))+c ))));
     ...
     cjText2_FuncionInicial.setText(String.valueOf(a + "t" + "^" + ((int)+ exp)  +"   "+ b + "t" + "^" + ((int)+( exp - 1)) +"   "+ c + "t"));
            cjText2_FuncionDerivada.setText(String.valueOf((int)(exp*a)+"t"+"^"+(exp-1)+"   "+((int)(exp-1)*b)+"t"+"^"+(exp-2)+"   "+c));
         cjText2_RESULTADO.setText(String.valueOf((int)(((exp*a)*Math.pow(tiempo, exp-1))-((((exp-1)*b)*-1)*Math.pow(tiempo, exp-2))-(c*-1))));
